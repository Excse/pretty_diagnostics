...
![Screenshot of Doxygen Awesome CSS](../doxygen-awesome-css/img/screenshot.png)
...
![Available theme variants](../doxygen-awesome-css/img/theme-variants.drawio.svg)
...
- [Installing extensions](../doxygen-awesome-css/docs/extensions.md)
- [Customizing the theme (colors, spacing, border-radius, ...)](../doxygen-awesome-css/docs/customization.md)
- [Tips and Tricks for further configuration](../doxygen-awesome-css/docs/tricks.md)
...
Read Next: [Extensions](../doxygen-awesome-css/docs/extensions.md)
</span>